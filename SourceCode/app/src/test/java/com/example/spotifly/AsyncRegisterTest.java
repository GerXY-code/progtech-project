...
public class AsyncRegisterTest {
    ...
    public void doInBackground() {
        ...
        try {
            ...
            hashedTestPassword = testPassword.hashCode();
            statement.executeUpdate("INSERT INTO users(username,email,password) VALUES('"+testUsername+"','test@test.com','"+hashedTestPassword+"')");
